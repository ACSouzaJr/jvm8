...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo referência no array. \index{interpreter.\+h@{interpreter.\+h}!aastore\+\_\+eval@{aastore\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo reference. \index{interpreter.\+h@{interpreter.\+h}!aconst\+\_\+null\+\_\+eval@{aconst\+\_\+null\+\_\+eval}}
...
Usa como parâmetro um índice que é usado no vetor de variáveis locais, para colocar na pilha de operandos a referência correspondente aquele índice. \index{interpreter.\+h@{interpreter.\+h}!anewarray\+\_\+eval@{anewarray\+\_\+eval}}
...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo byte ou booleano no array. \index{interpreter.\+h@{interpreter.\+h}!bastore\+\_\+eval@{bastore\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo byte ou boolean. \index{interpreter.\+h@{interpreter.\+h}!bipush\+\_\+eval@{bipush\+\_\+eval}}
...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo char no array. \index{interpreter.\+h@{interpreter.\+h}!castore\+\_\+eval@{castore\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo char. \index{interpreter.\+h@{interpreter.\+h}!checkcast\+\_\+eval@{checkcast\+\_\+eval}}
...
Soma os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!daload\+\_\+eval@{daload\+\_\+eval}}
...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo double no array. \index{interpreter.\+h@{interpreter.\+h}!dastore\+\_\+eval@{dastore\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo double. \index{interpreter.\+h@{interpreter.\+h}!dcmpg\+\_\+eval@{dcmpg\+\_\+eval}}
...
Divide os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!dload\+\_\+0\+\_\+eval@{dload\+\_\+0\+\_\+eval}}
...
Multiplica os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!dneg\+\_\+eval@{dneg\+\_\+eval}}
...
Subtrai os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!dup2\+\_\+eval@{dup2\+\_\+eval}}
...
Só usado para int -\/$>$ cat1 \index{interpreter.\+h@{interpreter.\+h}!dup\+\_\+x2\+\_\+eval@{dup\+\_\+x2\+\_\+eval}}
...
Soma os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!faload\+\_\+eval@{faload\+\_\+eval}}
...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo float no array. \index{interpreter.\+h@{interpreter.\+h}!fastore\+\_\+eval@{fastore\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo float. \index{interpreter.\+h@{interpreter.\+h}!fcmpg\+\_\+eval@{fcmpg\+\_\+eval}}
...
Divide os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!fload\+\_\+0\+\_\+eval@{fload\+\_\+0\+\_\+eval}}
...
Multiplica os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!fneg\+\_\+eval@{fneg\+\_\+eval}}
...
Subtrai os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!getfield\+\_\+eval@{getfield\+\_\+eval}}
...
O objectref deve ser do tipo reference e é retirado da pilha de operandos. O valor de um field é acessado na constant pool, o qual dá o nome e o descriptor de um field assim como uma referência simbólica para a classe a qual ele pertence. \index{interpreter.\+h@{interpreter.\+h}!getstatic\+\_\+eval@{getstatic\+\_\+eval}}
...
A função \hyperlink{helpers_8c_a0a7debb62b7ecdf5d62fce5afb081b92}{get\+Index\+Fromb1b2()} é usada para calcular um indice que é usado para acessar um field na constant pool. \index{interpreter.\+h@{interpreter.\+h}!goto\+\_\+eval@{goto\+\_\+eval}}
...
Soma os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!iaload\+\_\+eval@{iaload\+\_\+eval}}
...
Divide os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!if\+\_\+acmpeq\+\_\+eval@{if\+\_\+acmpeq\+\_\+eval}}
...
Valor1 e Valor2 são retirados da pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!if\+\_\+acmpne\+\_\+eval@{if\+\_\+acmpne\+\_\+eval}}
...
Valor1 e Valor2 são retirados da pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!if\+\_\+icmpeq\+\_\+eval@{if\+\_\+icmpeq\+\_\+eval}}
...
Valor1 e Valor2 são retirados da pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!if\+\_\+icmpgt\+\_\+eval@{if\+\_\+icmpgt\+\_\+eval}}
...
Valor1 e Valor2 são retirados da pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!if\+\_\+icmple\+\_\+eval@{if\+\_\+icmple\+\_\+eval}}
...
Valor1 e Valor2 são retirados da pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!if\+\_\+icmplt\+\_\+eval@{if\+\_\+icmplt\+\_\+eval}}
...
Valor1 e Valor2 são retirados da pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!if\+\_\+icmpne\+\_\+eval@{if\+\_\+icmpne\+\_\+eval}}
...
Multiplica os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!ineg\+\_\+eval@{ineg\+\_\+eval}}
...
Subtrai os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!iushr\+\_\+eval@{iushr\+\_\+eval}}
...
Endereço do opcode que segue imediatamente a instrução é colocado na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!jsr\+\_\+w\+\_\+eval@{jsr\+\_\+w\+\_\+eval}}
...
Soma os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!laload\+\_\+eval@{laload\+\_\+eval}}
...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo long no array. \index{interpreter.\+h@{interpreter.\+h}!land\+\_\+eval@{land\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo long. \index{interpreter.\+h@{interpreter.\+h}!lcmp\+\_\+eval@{lcmp\+\_\+eval}}
...
O índice de acesso a constant pool deve ser de categoria 1. Caso seja int ou float, seu valor é levado à cp como int, ou float Caso seja String, então a referência value para aquela instância é levada a op\+\_\+stack Caso seja uma referência para uma classe, é retornada uma referência para a class \hyperlink{structObject}{Object} \mbox{[}0\mbox{]} \index{interpreter.\+h@{interpreter.\+h}!ldc\+\_\+w\+\_\+eval@{ldc\+\_\+w\+\_\+eval}}
...
Divide os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!lload\+\_\+0\+\_\+eval@{lload\+\_\+0\+\_\+eval}}
...
Multiplica os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!lneg\+\_\+eval@{lneg\+\_\+eval}}
...
Subtrai os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+h@{interpreter.\+h}!lushr\+\_\+eval@{lushr\+\_\+eval}}
...
Utiliza um parâmetro para saber que tipo de array criar. \index{interpreter.\+h@{interpreter.\+h}!nop\+\_\+eval@{nop\+\_\+eval}}
...
Só pode ser usado para long/double -\/$>$ cat2 \index{interpreter.\+h@{interpreter.\+h}!pop\+\_\+eval@{pop\+\_\+eval}}
...
Só pode ser usado para int -\/$>$ cat1 \index{interpreter.\+h@{interpreter.\+h}!putfield\+\_\+eval@{putfield\+\_\+eval}}
...
A função \hyperlink{helpers_8c_a0a7debb62b7ecdf5d62fce5afb081b92}{get\+Index\+Fromb1b2()} é usada para calcular um indice que é usado para acessar um field na constant pool e guardar o seu valor. \index{interpreter.\+h@{interpreter.\+h}!resolve\+Class@{resolve\+Class}}
...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo short no array. \index{interpreter.\+h@{interpreter.\+h}!sastore\+\_\+eval@{sastore\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo short. \index{interpreter.\+h@{interpreter.\+h}!sipush\+\_\+eval@{sipush\+\_\+eval}}
