...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo referência no array. \index{interpreter.\+c@{interpreter.\+c}!aastore\+\_\+eval@{aastore\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo reference. \index{interpreter.\+c@{interpreter.\+c}!aconst\+\_\+null\+\_\+eval@{aconst\+\_\+null\+\_\+eval}}
...
Usa como parâmetro um índice que é usado no vetor de variáveis locais, para colocar na pilha de operandos a referência correspondente aquele índice. \index{interpreter.\+c@{interpreter.\+c}!anewarray\+\_\+eval@{anewarray\+\_\+eval}}
...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo byte ou booleano no array. \index{interpreter.\+c@{interpreter.\+c}!bastore\+\_\+eval@{bastore\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo byte ou boolean. \index{interpreter.\+c@{interpreter.\+c}!bipush\+\_\+eval@{bipush\+\_\+eval}}
...
Faz um push na pilha de operandos de um byte. O byte tem seu sinal extendido para um valor int. \index{interpreter.\+c@{interpreter.\+c}!breakpoint\+\_\+eval@{breakpoint\+\_\+eval}}
...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo char no array. \index{interpreter.\+c@{interpreter.\+c}!castore\+\_\+eval@{castore\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo char. \index{interpreter.\+c@{interpreter.\+c}!checkcast\+\_\+eval@{checkcast\+\_\+eval}}
...
Soma os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!daload\+\_\+eval@{daload\+\_\+eval}}
...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo double no array. \index{interpreter.\+c@{interpreter.\+c}!dastore\+\_\+eval@{dastore\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo double. \index{interpreter.\+c@{interpreter.\+c}!dcmpg\+\_\+eval@{dcmpg\+\_\+eval}}
...
Divide os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!dload\+\_\+0\+\_\+eval@{dload\+\_\+0\+\_\+eval}}
...
Multiplica os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!dneg\+\_\+eval@{dneg\+\_\+eval}}
...
Subtrai os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!dup2\+\_\+eval@{dup2\+\_\+eval}}
...
Só usado para int -\/$>$ cat1 \index{interpreter.\+c@{interpreter.\+c}!dup\+\_\+x2\+\_\+eval@{dup\+\_\+x2\+\_\+eval}}
...
Soma os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!faload\+\_\+eval@{faload\+\_\+eval}}
...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo float no array. \index{interpreter.\+c@{interpreter.\+c}!fastore\+\_\+eval@{fastore\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo float. \index{interpreter.\+c@{interpreter.\+c}!fcmpg\+\_\+eval@{fcmpg\+\_\+eval}}
...
Divide os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!fload\+\_\+0\+\_\+eval@{fload\+\_\+0\+\_\+eval}}
...
Multiplica os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!fneg\+\_\+eval@{fneg\+\_\+eval}}
...
Subtrai os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!getfield\+\_\+eval@{getfield\+\_\+eval}}
...
O objectref deve ser do tipo reference e é retirado da pilha de operandos. O valor de um field é acessado na constant pool, o qual dá o nome e o descriptor de um field assim como uma referência simbólica para a classe a qual ele pertence. \index{interpreter.\+c@{interpreter.\+c}!getstatic\+\_\+eval@{getstatic\+\_\+eval}}
...
A função \hyperlink{helpers_8c_a0a7debb62b7ecdf5d62fce5afb081b92}{get\+Index\+Fromb1b2()} é usada para calcular um indice que é usado para acessar um field na constant pool. \index{interpreter.\+c@{interpreter.\+c}!goto\+\_\+eval@{goto\+\_\+eval}}
...
Soma os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!iaload\+\_\+eval@{iaload\+\_\+eval}}
...
Divide os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!if\+\_\+acmpeq\+\_\+eval@{if\+\_\+acmpeq\+\_\+eval}}
...
Valor1 e Valor2 são retirados da pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!if\+\_\+acmpne\+\_\+eval@{if\+\_\+acmpne\+\_\+eval}}
...
Valor1 e Valor2 são retirados da pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!if\+\_\+icmpeq\+\_\+eval@{if\+\_\+icmpeq\+\_\+eval}}
...
Valor1 e Valor2 são retirados da pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!if\+\_\+icmpgt\+\_\+eval@{if\+\_\+icmpgt\+\_\+eval}}
...
Valor1 e Valor2 são retirados da pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!if\+\_\+icmple\+\_\+eval@{if\+\_\+icmple\+\_\+eval}}
...
Valor1 e Valor2 são retirados da pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!if\+\_\+icmplt\+\_\+eval@{if\+\_\+icmplt\+\_\+eval}}
...
Valor1 e Valor2 são retirados da pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!if\+\_\+icmpne\+\_\+eval@{if\+\_\+icmpne\+\_\+eval}}
...
Multiplica os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!ineg\+\_\+eval@{ineg\+\_\+eval}}
...
Subtrai os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!iushr\+\_\+eval@{iushr\+\_\+eval}}
...
Endereço do opcode que segue imediatamente a instrução é colocado na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!jsr\+\_\+w\+\_\+eval@{jsr\+\_\+w\+\_\+eval}}
...
Soma os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!laload\+\_\+eval@{laload\+\_\+eval}}
...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo long no array. \index{interpreter.\+c@{interpreter.\+c}!land\+\_\+eval@{land\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo long. \index{interpreter.\+c@{interpreter.\+c}!lcmp\+\_\+eval@{lcmp\+\_\+eval}}
...
Recebe dois bytes e os junta em um intermediário de 16 bits, os quais são usados como índice na constant pool. O valor numérico naquela posição da constant pool é colocado na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!ldc\+\_\+eval@{ldc\+\_\+eval}}
...
O índice de acesso a constant pool deve ser de categoria 1. Caso seja int ou float, seu valor é levado à cp como int, ou float Caso seja String, então a referência value para aquela instância é levada a op\+\_\+stack Caso seja uma referência para uma classe, é retornada uma referência para a class \hyperlink{structObject}{Object} \mbox{[}0\mbox{]} \index{interpreter.\+c@{interpreter.\+c}!ldc\+\_\+w\+\_\+eval@{ldc\+\_\+w\+\_\+eval}}
...
Divide os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!lload\+\_\+0\+\_\+eval@{lload\+\_\+0\+\_\+eval}}
...
Multiplica os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!lneg\+\_\+eval@{lneg\+\_\+eval}}
...
Subtrai os valores do topo da pilha de operandos e guarda o valor na pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!lushr\+\_\+eval@{lushr\+\_\+eval}}
...
Utiliza um parâmetro para saber que tipo de array criar. \index{interpreter.\+c@{interpreter.\+c}!nop\+\_\+eval@{nop\+\_\+eval}}
...
Só pode ser usado para long/double -\/$>$ cat2 \index{interpreter.\+c@{interpreter.\+c}!pop\+\_\+eval@{pop\+\_\+eval}}
...
Só pode ser usado para int -\/$>$ cat1 \index{interpreter.\+c@{interpreter.\+c}!putfield\+\_\+eval@{putfield\+\_\+eval}}
...
O objectref deve ser do tipo reference e é retirado da pilha de operandos. O valor de um field é acessado na constant pool, o qual dá o nome e o descriptor de um field assim como uma referência simbólica para a classe a qual ele pertence. O valor do field é setado. \index{interpreter.\+c@{interpreter.\+c}!putstatic\+\_\+eval@{putstatic\+\_\+eval}}
...
A função \hyperlink{helpers_8c_a0a7debb62b7ecdf5d62fce5afb081b92}{get\+Index\+Fromb1b2()} é usada para calcular um indice que é usado para acessar um field na constant pool e guardar o seu valor. \index{interpreter.\+c@{interpreter.\+c}!ret\+\_\+eval@{ret\+\_\+eval}}
...
O arrayref e o índice são tirados da pilha de operandos e usados para acessar um valor do tipo short no array. \index{interpreter.\+c@{interpreter.\+c}!sastore\+\_\+eval@{sastore\+\_\+eval}}
...
O arrayref deve ser do tipo reference e deve referir a um array cujos elementos sejam variáveis do tipo short. \index{interpreter.\+c@{interpreter.\+c}!sipush\+\_\+eval@{sipush\+\_\+eval}}
...
Recebe dois bytes e os junta em um intermediário de 16 bits, para futuramente extender seu sinal e dar push para a pilha de operandos. \index{interpreter.\+c@{interpreter.\+c}!swap\+\_\+eval@{swap\+\_\+eval}}
